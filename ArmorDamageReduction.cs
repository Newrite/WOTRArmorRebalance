...
namespace ArmorDamageReduction
{
    ...
    internal static class GameHistoryLogModCombat
    {
        ...
        private static void UpdateSpellsAndResources(UnitEntityData unit)
        {
    ...
    internal static class BlueprintPatcher
    {
        ...
        private static string[] _enchantsNameGuids =
        {
        ...
        private static string[] _enchantsDescGuids =
        {
        ...
        private static string[] _enchantsGuids =
        {
        ...
        private static BlueprintFeature GetOrCreateDamageReductionFeature(int reductionValue)
        {
            ...
            var guid = _featuresGuids[reductionValue];
            ...
            BlueprintFeature drFeature)
        {
            ...
            var descriptionLocalKey = _enchantsDescGuids[reductionValue];
            var description = $"Уменьшает получаемый физический урон на {reductionValue} единиц.";
            var enchantmentLocalKey = _enchantsNameGuids[reductionValue];
            ...
            var guid = _enchantsGuids[reductionValue];
